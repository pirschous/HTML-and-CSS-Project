...
function showSlides(n) {
    var slides = document.getElementsByClassName("mySlides"); //This takes all elements with the class name "mySlides" and stores them in the variable array "slides"
        ...
        if (n < 1) (slideIndex = slides.length); //If n (the number passed into the function) is less than 1, the slideIndex is set to the lenth of the array "slides"
...
// This code will create close the contact form when teh user clicks off of it
